              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: widget.userType == UserType.personal
                                  ? (_userNames.isEmpty ? 'Vnesite svoje ime' : 'Vnesite še eno ime')
                    ...
                    if (widget.userType == UserType.personal && _userNames.isNotEmpty) ...[
                      Container(
  ...
  String _getTitle() {
    switch (widget.userType) {
      case UserType.personal:
        return _userNames.isEmpty ? 'Vnesite vaše ime' : 'Odlično, ${_userNames[0]}!';
