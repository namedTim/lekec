...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): NotificationSettingsWire {
      ...
      val actionButtons = if (pigeonVar_list.size > 8) pigeonVar_list[8] as String? else null
      return NotificationSettingsWire(title, body, stopButton, icon, iconColorAlpha, iconColorRed, iconColorGreen, iconColorBlue, actionButtons)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
