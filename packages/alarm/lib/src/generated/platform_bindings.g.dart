...
class NotificationSettingsWire {
  ...
  /// Fork addition: JSON-encoded list of custom notification action buttons.
  /// Trailing nullable field so platforms that don't read it stay compatible.
  ...
  static NotificationSettingsWire decode(Object result) {
    ...
    return NotificationSettingsWire(
      ...
      actionButtons: result.length > 8 ? result[8] as String? : null,
    );
  }
